        ...
        >
          <div class="relative h-48 bg-slate-100 dark:bg-slate-800 overflow-hidden">
            ...
            <button
              ...
              class="absolute top-3 right-3 p-1.5 bg-white/90 dark:bg-slate-900/90 rounded-full hover:bg-white dark:hover:bg-slate-900 transition-colors shadow-sm"
          ...
          <div class="p-4">
            ...
            <div class="flex gap-2">
              <button
                ...
                class="flex-1 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-semibold py-2 px-3 rounded-lg text-sm transition-colors"
              >
                Ver Perfil
              </button>
              <button
